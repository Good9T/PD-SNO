...
class Model(nn.Module):
    ...
    def pre_forward(self, reset_state):
        ...
        self.encoded_node = self.encoder(reset_state)
...
class Encoder(nn.Module):
    ...
    def forward(self, reset_state):
        ...
        embedded_pick = self.embedding_pick(pick_x_y_demand)
        embedded_delivery = self.embedding_delivery(delivery_x_y_demand)
